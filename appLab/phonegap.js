...
if( typeof(AppMobi) == "undefined" || ( typeof(AppMobi) != "undefined" && typeof(AppMobi.device) == "undefined" ) )
{
    ...
    var headscr = document.head;
    if( typeof(headscr) == "undefined" )
        headscr = document.getElementsByTagName('head')[0];
	headscr.appendChild(amscr);
}
...
function loadPhoneGap()
{
	...
	{
		AppMobi.exec("AppMobiDevice.registerLibrary", "PhoneGapModule");
	}
}
...
if (typeof PhoneGap === "undefined") {
	...
	PhoneGap.run_command = function() {
		...
		try {
			...
			// [appMobi removed] var url = "gap://" + PhoneGap.sessionKey + "@" + service + next + uri.join("/"); 
			var url = "appmobi://" + service + next + uri.join("/"); // [appMobi added]
		...
		setTimeout("PhoneGap.queue.ready = true;", 5); // [appMobi added]
	};
	/**
