...
// [appMobi removed] @synthesize webView;
@synthesize settings;
...
{
    // [appMobi removed] self = [super init];
    self = [super initWithWebView: (AppMobiWebView *) theWebView]; // [appMobi added]
    if (self) {
		...
		// [appMobi removed] self.webView = theWebView;
...
{
	self.settings = nil;
	// [appMobi removed] self.webView = nil;
...
{
	return (AppMobiDelegate*)[[UIApplication sharedApplication] delegate];
}
