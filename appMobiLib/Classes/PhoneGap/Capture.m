...
#import "JSON.h"
// [appMobi added] #import "PhoneGapDelegate.h"
...
- (void) getFormatData: (NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
    ...
    if (!mimeType){
        ...
        // [appMobi removed] PGFile* pgFile = [[self appDelegate] getCommandInstance: @"com.phonegap.file"];
        PGFile* pgFile = [webView getCommandInstance: @"com.phonegap.file"]; // [appMobi added]
